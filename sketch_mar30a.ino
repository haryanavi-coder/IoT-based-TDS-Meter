...
String apiKey = "OC82VVBJGID4JV8E";     //  Enter your Write API key from ThingSpeak
 
const char *ssid =  "NSUT-Campus";     // replace with your wifi ssid and wpa2 key
//const char *pass =  "rohit000";
